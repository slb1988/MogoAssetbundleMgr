...
public class OKCancelBox : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        m_spOKBgUp = m_myTransform.FindChild("OKButton/OKButtonBGUp").GetComponentsInChildren<UISprite>(true)[0];
        m_spOKBgDown = m_myTransform.FindChild("OKButton/OKButtonBGDown").GetComponentsInChildren<UISprite>(true)[0];
        m_spCancelBgUp = m_myTransform.FindChild("CancelButton/CancelButtonBGUp").GetComponentsInChildren<UISprite>(true)[0];
        m_spCancelBgDown = m_myTransform.FindChild("CancelButton/CancelButtonBGDown").GetComponentsInChildren<UISprite>(true)[0];
