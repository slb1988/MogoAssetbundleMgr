...
public class InstanceLevelGrid : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        m_spBGUp = m_myTransform.FindChild("InstanceLevel" + id + "BG/" + "InstanceLevel" + id + "BGUp").GetComponentsInChildren<UISprite>(true)[0];
        m_spBGDown = m_myTransform.FindChild("InstanceLevel" + id + "BG/" + "InstanceLevel" + id + "BGDown").GetComponentsInChildren<UISprite>(true)[0];

        m_spGridIcon = m_myTransform.FindChild("InstanceLevel" + id + "Icon").GetComponentsInChildren<UISprite>(true)[0];

        Mogo.Util.LoggerHelper.Debug("InstanceLevel" + id + "StarList/" +
            "InstanceLevel" + id + "Star0/" + "InstanceLevel" + id + "Star0BGUp");
        m_spGridStar0Up = m_myTransform.FindChild("InstanceLevel" + id + "StarList/" + 
            "InstanceLevel" + id + "Star0/" + "InstanceLevel" + id + "Star0BGUp").GetComponentsInChildren<UISprite>(true)[0];

        m_spGridStar1Up = m_myTransform.FindChild("InstanceLevel" + id + "StarList/" +
            "InstanceLevel" + id + "Star1/" + "InstanceLevel" + id + "Star1BGUp").GetComponentsInChildren<UISprite>(true)[0];

        m_spGridStar2Up = m_myTransform.FindChild("InstanceLevel" + id + "StarList/" +
            "InstanceLevel" + id + "Star2/" + "InstanceLevel" + id + "Star2BGUp").GetComponentsInChildren<UISprite>(true)[0];

        m_spGridStar0Down = m_myTransform.FindChild("InstanceLevel" + id + "StarList/" +
            "InstanceLevel" + id + "Star0/" + "InstanceLevel" + id + "Star0BGDown").GetComponentsInChildren<UISprite>(true)[0];

        m_spGridStar1Down = m_myTransform.FindChild("InstanceLevel" + id + "StarList/" +
            "InstanceLevel" + id + "Star1/" + "InstanceLevel" + id + "Star1BGDown").GetComponentsInChildren<UISprite>(true)[0];

        m_spGridStar2Down = m_myTransform.FindChild("InstanceLevel" + id + "StarList/" +
            "InstanceLevel" + id + "Star2/" + "InstanceLevel" + id + "Star2BGDown").GetComponentsInChildren<UISprite>(true)[0];

        m_spRewardBG = m_myTransform.FindChild("InstanceLevel" + id + "Thing1").GetComponentsInChildren<UISlicedSprite>(true)[0];

        m_spReward0 = m_myTransform.FindChild("InstanceLevel" + id + "RewardList/" + "InstanceLevel" + id + "Reward0").GetComponentsInChildren<UISlicedSprite>(true)[0];
        m_spReward1 = m_myTransform.FindChild("InstanceLevel" + id + "RewardList/" + "InstanceLevel" + id + "Reward1").GetComponentsInChildren<UISlicedSprite>(true)[0];

        if (id == 2)
        {
            m_spDiamondBtn = m_myTransform.FindChild("InstanceLevel2Diamond/InstanceLevel2DiamondUp").GetComponentsInChildren<UISlicedSprite>(true)[0];
 
        }

        m_lblChallengeNum = m_myTransform.FindChild("InstanceLevel" + id + "ChallengeTimesNum").GetComponentsInChildren<UILabel>(true)[0];
        m_lblSuggestLevel = m_myTransform.FindChild("InstanceLevel" + id + "SuggestLevelNum").GetComponentsInChildren<UILabel>(true)[0];
    }
